...
var utils = {
  ...
  getImgMarkup: function getImgMarkup(index, src, altAttr, srcset, sizes, sources) {
    ...
    var imgMarkup = "<img crossorigin=\u201Canonymous\u201D ".concat(altAttr, " ").concat(srcsetAttr, "  ").concat(sizesAttr, " class=\"lg-object lg-image\" data-index=\"").concat(index, "\" src=\"").concat(src, "\" />");
    var sourceTag = '';
